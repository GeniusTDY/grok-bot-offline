...
const UI_TEXT_EN = {
  ...
  configureRouter: "Configure Proxy Gateway",
  finishRouterSetup: "Finish Proxy Gateway setup",
  copied: "Copied",
...
const UI_TEXT_ZH: Record<keyof typeof UI_TEXT_EN, string> = {
  ...
  configureRouter: "配置 Proxy Gateway",
  finishRouterSetup: "完成 Proxy Gateway 设置",
  copied: "已复制",
