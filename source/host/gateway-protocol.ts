...
export const SAND_GATEWAY_COMMANDS = {
  ...
  leaseProxyGatewayCredential: (api: GatewayApi, body: string) => api.leaseProxyGatewayCredential(parseCommandArgs(body)),
  probeProxyGatewayModels: (api: GatewayApi) => api.probeProxyGatewayModels(),
